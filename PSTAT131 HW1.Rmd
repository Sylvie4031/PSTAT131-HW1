...
```{r}
ggplot(mpg,aes(y=hwy,x=factor(cyl)))+geom_boxplot()+labs(x="Number of Cylinders",y="Highway Miles per Gallon")

```
Observation: I notice that cars with fewer cylinders can drive more miles per gallon. In other words, cars with more cylinders consume more gas. 
